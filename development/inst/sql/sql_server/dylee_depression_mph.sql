...
SELECT 23 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
                                            ( 
                                              select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (442306,440383,4175329,436677)
                                              UNION  select c.concept_id
                                              from @vocabulary_database_schema.CONCEPT c
                                              join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
                                              and ca.ancestor_concept_id in (442306,440383,4175329,436677)
                                              and c.invalid_reason is null
...
SELECT 24 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
                                            ( 
                                              ...
                                              from @vocabulary_database_schema.CONCEPT c
                                              join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
                                              and ca.ancestor_concept_id in (4219484,4303690)
                                              and c.invalid_reason is null
